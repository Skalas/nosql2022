...
** Correo
Escribe a ~miguel.escalante@itam.mx~ y por favor que el subject del correo diga ~[NOSQL 2022]~.
** Discord
...
* Usuarios Github
Por favor [[https://forms.gle/1CFZvKkHHL3segZu9][entren aquí]] para llenar sus usuarios de github.
